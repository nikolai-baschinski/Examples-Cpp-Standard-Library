...
class BigData3 {
public:
    BigData3(std::vector<int>& data, std::string& str) :data(data), str(str) { cout << "copy, copy" << endl; }
    BigData3(std::vector<int>& data, std::string&& str) :data(data), str(std::move(str)) { cout << "copy, move" << endl; }
    BigData3(std::vector<int>&& data, std::string& str) :data(std::move(data)), str(str) { cout << "move, copy" << endl; }
    BigData3(std::vector<int>&& data, std::string&& str) :data(std::move(data)), str(std::move(str)) { cout << "move, move" << endl; }
private:
    std::vector<int> data;
    std::string str;
};
